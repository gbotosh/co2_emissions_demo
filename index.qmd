...
```{python}
# Load the data
emissions = pd.read_csv("data/co2_emission.csv")
```
...
table_df["Absolute Change"] = (table_df["2022"] - table_df["2000"]).abs()
...
emissions_long_subset = emissions_long_1990_2022.query('country in ["China", "Germany", "Netherlands", "Italy", "France"]')

#emissions_long_subset.info()
